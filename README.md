...
Utilizei da definiçãoi do controller para implementar os métodos criados no repositório e definir métodos adicionais para a validação.
...
então, opetei por realizar o tratamento delas individualmente no próprio 'UsuarioController'.
...
Como encontrei uma situação onde ocorria um erro ao alterar o usuário, mantendo as informações, optei por realizar a sobrecarga para evitar a situação,
